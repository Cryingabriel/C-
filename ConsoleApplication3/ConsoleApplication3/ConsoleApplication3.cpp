...
int main()
{
    ...
    while (stop == false)
    {
        ...
        string choice2;
        int choice3;
        cout << "what do you wish to do? 1) push, 2) pop, 3) display, 4) size, or 5 quit" << endl;
        cin >> choice;
        switch (choice) {
            case 1:
                cout << "what do you wish to type?" << endl;
                cin >> choice2;
                cout << "which stack do you wish to push it in? 1) blue or 2) red" << endl;
                cin >> choice3;
                if (choice3 == 1) {
                    bluepush(choice2);
                }
